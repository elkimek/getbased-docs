  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Drop any lab report — any format, language, or country. AI maps hundreds of built-in and specialty biomarkers automatically.
        </span>
      </div>
    </a>
    <a
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
            Sync Oura, Withings, or Polar; import Apple Health; or self-host Google Health.
          </span>
        </div>
      </a>
      <a
