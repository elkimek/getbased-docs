...
description: Free, local-first health dashboard unifying blood work, DNA, meals, wearables, and light exposure with optional AI analysis. No account required.
mode: frame
---
...
<div data-product-guide-index className="flex w-full flex-col gap-8 max-w-5xl mx-auto px-4 md:px-8 lg:px-12 py-10 lg:gap-14 lg:py-16">
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    <a
      href="/guides/meals-nutrition"
      className="rounded-2xl flex flex-col gap-4 border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
    >
      <Icon icon="utensils" color="rgb(var(--primary))" size={18} className="shrink-0" />
      <div className="flex flex-col gap-1">
        <span className="font-serif text-base font-medium text-gray-900 dark:text-gray-50">Meals & Nutrition</span>
        <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Log editable photo, label, or manual meals and review coverage-aware targets, timing, trends, and model benchmarks.
        </span>
      </div>
    </a>
    <a
      ...
      className="rounded-2xl flex flex-col gap-4 border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
    >
      <Icon icon="audio-lines" color="rgb(var(--primary))" size={18} className="shrink-0" />
      <div className="flex flex-col gap-1">
        <span className="font-serif text-base font-medium text-gray-900 dark:text-gray-50">Voice chat</span>
        <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Dictate messages and hear AI replies with private on-device models or a voice service you choose.
        </span>
      </div>
    </a>
    <a
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Drop a lab report, review recognized and custom results, and keep the source laboratory's ranges and collection context.
        </span>
      </div>
    </a>
    <a
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
            Connect a cloud provider, compatible endpoint, or downloaded model running on your own hardware.
          </span>
        </div>
      </a>
      <a
        href="/guides/ai-model-testing"
        className="rounded-2xl flex flex-col gap-4 border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
      >
        <Icon icon="gauge" color="rgb(var(--primary))" size={18} className="shrink-0" />
        <div className="flex flex-col gap-1">
          <span className="font-serif text-base font-medium text-gray-900 dark:text-gray-50">Compare AI models</span>
          <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
            Measure lab-import accuracy and speed across local models, hosted endpoints, and cloud providers.
          </span>
        </div>
      </a>
      <a
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
            Sync Oura, Withings, or Polar; import Apple Health; or self-host WHOOP or Google Health.
          </span>
        </div>
      </a>
      <a
        href="/guides/context-cards"
        className="rounded-2xl flex flex-col gap-4 border bg-gray-50 p-4 outline-none shadow-sm shadow-gray-950/5 transition hover:border-primary hover:shadow-md dark:bg-gray-950 dark:shadow-black/20 dark:hover:border-primary"
      >
