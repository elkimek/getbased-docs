...
<Info>
  To start with a button or action in the application, use [Find the request by action](/guides/ai-prompts#find-the-request-by-action). It shows what getbased adds, what data accompanies the request, and links directly to the readable prompt text below.
</Info>
