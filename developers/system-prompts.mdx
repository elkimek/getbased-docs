...
<CardGroup cols={2}>
  ...
  <Card title="Meals and Nutrition" icon="utensils" href="/developers/system-prompts-nutrition">
    Meal photos, nutrition labels, corrections, benchmarks, and selected-history chat handoff.
  </Card>
...
| `nutrition.meal-photo` | Meal-photo analysis and benchmarks | Multimodal user task + JSON schema | [`js/nutrition-analysis.js`](https://github.com/elkimek/get-based/blob/main/js/nutrition-analysis.js) |
| `nutrition.label` | Nutrition-label analysis and benchmarks | Multimodal user task + JSON schema | [`js/nutrition-analysis.js`](https://github.com/elkimek/get-based/blob/main/js/nutrition-analysis.js) |
| `nutrition.history` | Selected nutrition-history chat handoff | Editable user message | [`js/nutrition-summary-context.js`](https://github.com/elkimek/get-based/blob/main/js/nutrition-summary-context.js) |
