...
```
            ...
            from UNIT_CONVERSIONS     │
                    ...
                    └────────┬────────┘
                             │
                             ▼
                 Apply marker placements
                 as the final view projection
                             │
                             ▼
                  ┌──────────────────────┐
                  │     Return data       │
...
These are computed in-pipeline in the native `calculatedRatios` category. A profile may then display a calculated marker in a compatible regular category, but calculation and storage resolution still happen at its native key:
