...
| `tests/test-adapters.js` | Adapter registry: structure, fatty acids, Metabolomix+, Mosaic OAT/MOAT catalogs, aliases, product isolation, and cross-adapter behavior |
