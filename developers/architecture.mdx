...
js/
  ...
  marker-schema/    — Category source modules, stable order, and built-in identity authoring
  marker-schema.js  — Generated runtime marker catalog; do not edit directly
  schema.js         — Stable marker-schema facade plus conversions, ranges, and thresholds
