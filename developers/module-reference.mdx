...
**Key exports:**
- `ADAPTER_MARKERS` — flat object keyed by `"category.markerKey"`: `{ name, unit, refMin, refMax, categoryLabel, icon, group, singlePoint? }` (220 entries). Re-exported from `schema.js` as `SPECIALTY_MARKER_DEFS`
