...
- `sync-identity.js` — BIP-39/QR lazy loaders plus mnemonic read/restore helpers; existing-identity joins suppress Evolu's internal reload, persist enabled owner state, then perform one controlled reload.
