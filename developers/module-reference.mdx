...
Local AI uses a normalized adapter layer so compatible endpoints work without hiding richer Ollama and LM Studio capabilities.
...
**Key exports:**
- `exportToJSON()` — exports v2 JSON for the current profile, including entries, context, custom marker identities, `markerPlacements`, notes, supplements, biometrics, genetics, Light/Sun data, and supported chat state
