...
description: "Get suggested next steps based on your labs, wearable data, light exposure, genetics, goals, and saved health context."
---
...
- Genetic associations that affect lab interpretation, with their separate evidence and relevance grades
...
Genome-derived hints keep the catalog's association direction, evidence strength, and personal-relevance label. They are context for a measured marker or recommendation slot, not genotype-specific prescriptions. For example, APOE context directs attention to measured LDL and ApoB response rather than declaring one diet from haplotype alone.
...
The recommendation button prepares a message in chat. You can edit it before sending and [read the maintained wording](/developers/system-prompts-chat#prompt-chat-prefills).
