...
For the full workflow, see [Measure EMF exposure in getbased](/guides/emf-assessment).
...
The Diet & Digestion card can surface food-contaminant warnings when your diet text matches known high-signal food items. These warnings are deterministic keyword/database checks, not AI diagnosis.
