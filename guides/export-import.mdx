...
A JSON export contains your complete health record for the current profile: all lab entries, context cards, notes, supplements, biometrics, genetics, cycle data, custom markers, marker category placements, and chat history.
