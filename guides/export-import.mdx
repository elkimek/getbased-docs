...
A JSON export contains your complete health record for the current profile: all lab entries, context cards, notes, structured supplement and medication records, biometrics, genetics, cycle data, custom markers, marker category placements, and chat history.
...
- Chat history, conversation threads, custom personas, and persona deletion records
