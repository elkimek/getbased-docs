...
The PDF report includes biomarker results, trends, a readable patient header, selected lab categories, context card summaries, therapy status and periods, active ingredients, separate other-ingredient and source-quality sections, notes, and the optional Practitioner Overview — formatted for sharing with a healthcare provider.
