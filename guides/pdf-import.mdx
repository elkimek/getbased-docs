...
<Steps>
  ...
  <Step title="Confirm">
    Click **Confirm** to save the results. Your values appear in Labs, dashboard widgets, marker details, comparisons, correlations, and AI context while **Blood marker results** are enabled in Manage → Context.
  </Step>
</Steps>
