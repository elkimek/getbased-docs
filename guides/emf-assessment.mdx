---
title: "Measure EMF exposure in getbased"
description: "Use the Baubiologie EMF Assessment to record room-by-room electric, magnetic, RF, dirty-electricity, and DC magnetic readings, then feed them into AI context and recommendations."
---

The EMF Assessment is a structured way to track electromagnetic field exposure in the places where you spend time. It lives inside the **Environment** context card and is included in AI context, export/import, sync, and recommendations.
...
getbased grades each measurement against SBM-2015-style building-biology thresholds. Sleeping areas are treated more strictly than daytime rooms because exposure duration and recovery biology are different.
