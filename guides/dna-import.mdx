...
| **Illumina GenomeStudio** | CSV with `[Header]`/`[Data]` blocks | Provided by your clinical lab |
...
After import, your genetic context surfaces in four places across the app.

**Dashboard** — a collapsible **Genetics** section shows your APOE haplotype and top findings grouped by category, sorted by severity. Initially shows up to 8 findings with a **Show all** button. Each finding links to its primary study on PubMed and a further-reading page on SNPedia.
