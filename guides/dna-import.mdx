...
**AI chat** — genetic context is controlled in **Insight → Manage → Context → Data sources → Genome**. You can include or exclude the high-level **APOE & mtDNA summary**, compact **Priority SNP findings**, and the broader **Other SNP lookup inventory** separately.
