...
<Info>
  [Read what getbased asks AI to extract](/developers/system-prompts-imports#prompt-import-supplement) from product pages and label photos. The instruction is limited to product facts and tells the model not to turn label directions into your personal regimen.
</Info>
...
See the maintained wording for the [supplement-impact summary](/developers/system-prompts-insights#prompt-insight-supplement-impact) and [app-written chat questions](/developers/system-prompts-chat#prompt-chat-prefills).
