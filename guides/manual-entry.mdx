...
- **Value** — starts with the current display unit and offers compatible International, Australia/NZ, US, and secondary clinical units when a safe conversion is known. Choose the unit printed on the report; getbased converts it back to canonical storage when you save.
...
See [Choose units for your region](/guides/unit-profiles) for display profiles, alternate units, and what remains unchanged in storage.
