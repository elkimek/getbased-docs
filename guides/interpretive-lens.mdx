...
Supported chat and insight requests include your lens text as part of the context when an AI provider is connected. The AI will:
...
getbased does not rewrite your saved lens. It adds the text to the request as context. You can [read where the lens appears in the chat instruction](/developers/system-prompts-chat#prompt-chat-context).
