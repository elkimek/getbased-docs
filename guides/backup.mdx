...
- Eligible wearable IndexedDB rows. OAuth tokens and always-device-encrypted Google Health raw rows are excluded; other device-local daily rows follow the active passphrase state.
