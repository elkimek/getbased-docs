...
- Each snapshot includes the active profile's stored data, including lab entries, context cards, notes, supplements, cycle data, per-profile preferences, and device-local AI model-test history.
